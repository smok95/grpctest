...
func (c *grpctestServiceClient) SendRequest(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/grpctest.GrpctestService/SendRequest", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedGrpctestServiceServer) SendRequest(context.Context, *Request) (*Response, error) {
...
func _GrpctestService_SendRequest_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Request)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GrpctestServiceServer).SendRequest(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/grpctest.GrpctestService/SendRequest",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GrpctestServiceServer).SendRequest(ctx, req.(*Request))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _GrpctestService_SendRequest_Handler,
		},
	},
